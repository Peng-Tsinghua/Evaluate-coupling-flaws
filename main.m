...
% [4] V. Vittal, ¡°Transient stability test systems for direct stability methods,¡± IEEE Transactions on Power Systems, vol. 7, no. 1, pp. 37¨C43, Feb. 1992, doi: 10.1109/59.141684.
%% Load case
clear;clc;
define_constants;
